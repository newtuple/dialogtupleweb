    ...
    <div className="bg-[#006666] p-32 y-32 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button className="px-10 py-4 bg-white text-[#006666] rounded-lg font-semibold hover:bg-primary-50 transition-colors text-lg shadow-enterprise-lg hover:shadow-enterprise">
            Start Free Trial
          </button>

...
export default function Hero() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-[#f0f7f7] to-white relative overflow-hidden pt-32 pb-24">
        {/* AI-themed background decorations */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-[#00666610] to-transparent rounded-full blur-3xl"></div>
          <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-br from-[#00666610] to-transparent rounded-full blur-3xl"></div>
        </div>
